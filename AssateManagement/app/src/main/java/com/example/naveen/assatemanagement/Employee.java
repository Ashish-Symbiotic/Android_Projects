...
import com.example.naveen.assatemanagement.databaseConnection.TotalEmployeeAssateWarranty;
...
public class Employee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView navigationView=(NavigationView)findViewById(R.id.navigationView6);
        final DrawerLayout drawerLayout=(DrawerLayout)findViewById(R.id.drawerLayout6);
                ...
                else
                {
                    ...
                    switch (item.getItemId())
                    {
                        case R.id.menu:
                            ...
                            return  true;
                        case R.id.profile:
                            startActivity(new Intent(Employee.this,Profile.class).putExtra("username","admin"));
                            finish();
                            return true;
                        case R.id.discription:
                            startActivity(new Intent(Employee.this,AssateDiscription.class));
                            finish();
                            return true;
                        case R.id.employee:
                            startActivity(new Intent(Employee.this,EmployeeDetail.class));
                            finish();
                            return true;
                        case R.id.returnAssate:
                            startActivity(new Intent(Employee.this,ReturnNotice.class));
                            finish();
                            return true;
        ...
        recyclerView=(ListView) findViewById(R.id.recyclerView3);
                    ...
                    public void onValueSelected(Entry e, Highlight h) {
                        ...
                        else
                        {
                            ...
                            try {
                                ...
                                {
                                    getObject=new JSONObject(new GetPieEmployee().execute(assateHolder.getTitle(),"out").get());
                                }
                                else if(finalJsonObject.getString("AboutTo").equals(String.valueOf((int)e.getY())))
                                {
                                    getObject=new JSONObject(new GetPieEmployee().execute(assateHolder.getTitle(),"still").get());
                                }
                                else
                                {
                                    getObject=new JSONObject(new GetPieEmployee().execute(assateHolder.getTitle(),"good").get());
                                }
                                ...
                                ArrayAdapter arrayAdapter=new ArrayAdapter(Employee.this,android.R.layout.simple_list_item_1,adpt.toArray());
    ...
    public List<AssateHolder> getData() {
        ...
        try {
            ...
            JSONObject assateObject=new JSONObject(new TotalEmployeeAssateWarranty().execute().get());
            JSONArray assateArray=assateObject.getJSONArray("EmployeeAssate");

            assaeteHolder=new AssateHolder("Total",new EmployeeAssateWarranty().execute().get());
