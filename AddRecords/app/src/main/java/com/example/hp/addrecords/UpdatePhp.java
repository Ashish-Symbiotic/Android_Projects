 ...
 */
public class UpdatePhp extends AsyncTask<String,Void,String> {
   Context context;
    public UpdatePhp(Context context)
    {
    ...
    protected String doInBackground(String... params) {
       String result="";
        ...
        String Dealing=params[3];
        String Address=params[4];
        String AddUrl="http://192.168.56.1/Updateit.php";
        try {
